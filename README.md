...
- ### 3. [Scrum/project taken](#scrum)
         ...
         - ##### 3.2 [Data Verzamelen](#Datav)
         - ##### 3.3 [Data Knippen](#dataknip)
         - ##### 3.4 [Excel bestand koppelen aan data](#exc)
         - ##### 3.5 [Grafieken plotten](#grafiek)
         - ##### 3.6 [Literatuuronderzoek](#literatuur)
         - ##### 3.7 [rivacy onderzoek opnemen data](#privacy)
         - ##### 3.8 [Presentaties](#presentaties)
- ### 4. [Spark](#spark)
- ### 5. [Exploratory Data Analysis](#exp)
- ### 6. [Scrum opdracht](#opdracht)
- ### 7. [Clustering](#cluster)
- ### 8. [Calling bullshit](#bs)
...
### 3. Scrum/project taken <a name="scrum"></a>

**3.1 Scrumwise** <a name="scrumwise"></a>
...
**3.2 Data verzamelen** <a name="Datav"></a>
...
**3.3 Data knippen** <a name="dataknip"></a>
...
**3.4 Excel bestand koppelen aan data** <a name="exc"></a>
...
**3.5 Grafieken plotten** <a name="grafiek"></a>
...
**3.6 Literatuuronderzoek** <a name="literatuur"></a>
...
**3.7 Privacy onderzoek opnemen data** <a name="privacy"></a>
...
**3.8 Presentaties** <a name="presentaties"></a>
...
### 6. Scrum opdracht <a name="opdracht"></a>
...
### 8. Calling bullshit <a name="bs"></a>
